...
namespace GarnetJSON
{
    public class JsonSET : CustomObjectFunctions
    {
        ...
        public override bool Updater(ReadOnlySpan<byte> key, ref ObjectInput input, IGarnetObject jsonObject, ref (IMemoryOwner<byte>, int) output, ref RMWInfo rmwInfo)
        {
