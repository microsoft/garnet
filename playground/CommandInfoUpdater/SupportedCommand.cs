...
namespace CommandInfoUpdater
{
    ...
    public class SupportedCommand
    {
        private static readonly SupportedCommand[] AllSupportedCommands = [
            ...
            new("EXECIFGREATER", RespCommand.EXECIFGREATER),
            new("EXECIFMATCH", RespCommand.EXECIFMATCH),
            new("EXECIFNOTMATCH", RespCommand.EXECIFNOTMATCH),
            new("EXECWITHETAG", RespCommand.EXECWITHETAG),
