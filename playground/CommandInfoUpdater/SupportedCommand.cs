    ...
    public class SupportedCommand
    {
        private static readonly SupportedCommand[] AllSupportedCommands = [
            ...
            [
                ...
                new("CLUSTER|ADVANCE_TIME", RespCommand.CLUSTER_ADVANCE_TIME),
            ...
            new("RI.EXISTS", RespCommand.RIEXISTS, StoreType.Main),
            new("RI.GET", RespCommand.RIGET, StoreType.Main),
            new("RI.METRICS", RespCommand.RIMETRICS, StoreType.Main),
            ...
            new("SETWITHETAG", RespCommand.SETWITHETAG, StoreType.Main),
            ...
            new("XACK", RespCommand.XACK),
            new("XAUTOCLAIM", RespCommand.XAUTOCLAIM),
            new("XCLAIM", RespCommand.XCLAIM),
            new("XGROUP", RespCommand.XGROUP),
            new("XINFO", RespCommand.XINFO),
            new("XPENDING", RespCommand.XPENDING),
            new("XREAD", RespCommand.XREAD),
            new("XREADGROUP", RespCommand.XREADGROUP),
