...
**Branch:** `agents/read-handoff-sentinel-docs` on `skyline75489/garnet`

**Implementation HEAD before this handoff:** `f2c59fe78`
(`[Resp] Pool standalone replication frame buffers`)

**Tree before this handoff:** clean and synchronized with
`origin/agents/read-handoff-sentinel-docs`.
