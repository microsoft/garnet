...
namespace Garnet.client
{
    public sealed partial class GarnetClient
    {
        ...
        /// <param name="token"></param>
        /// <returns></returns>
        public void ExecuteFireAndForgetWithNoResponse(Memory<byte> op, Memory<byte> param1, ref Span<byte> param2, ref Span<byte> param3, CancellationToken token = default)
        {
            InternalExecuteFireAndForgetWithNoResponse(ref op, ref param1, ref param2, ref param3, token);
        }
        #endregion
