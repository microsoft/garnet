...
#pragma warning restore IDE0060 // Remove unused parameter
        ...
        void InternalExecuteFireAndForgetWithNoResponse(ref Memory<byte> op, ref Memory<byte> subop, ref Span<byte> param1, ref Span<byte> param2, CancellationToken token = default)
        {
            var totalLen = 0;
            var arraySize = 4;
