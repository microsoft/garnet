...
namespace Garnet.cluster
{
    ...
    public sealed partial class ClusterProvider : IClusterProvider
    {
        ...
        /// <inheritdoc />
        public IClusterSession CreateClusterSession(TransactionManager txnManager, IGarnetAuthenticator authenticator, UserHandle userHandle, GarnetSessionMetrics garnetSessionMetrics, BasicGarnetApi basicGarnetApi, LogRecordGarnetApi logRecordGarnetApi, StringBasicContext stringContext, VectorBasicContext vectorContext, INetworkSender networkSender, ILogger logger = null)
            => new ClusterSession(this, txnManager, authenticator, userHandle, garnetSessionMetrics, basicGarnetApi, logRecordGarnetApi, stringContext, vectorContext, networkSender, logger);
