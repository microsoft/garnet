...
namespace Garnet.cluster
{
    internal sealed unsafe partial class ClusterSession : IClusterSession
    {
        ...
        private bool NetworkClusterAddSlots(ReadOnlySpan<byte> bufSpan, int count, out bool invalidParameters)
        {
            ...
            if (!CheckACLPermissions(RespCommand.CLUSTER, RespCommandsInfo.SubCommandIds.ClusterAddSlots, count, out bool success))
            {
                return success;
            }
        ...
        private bool NetworkClusterAddSlotsRange(ReadOnlySpan<byte> bufSpan, int count, out bool invalidParameters)
        {
            ...
            if (!CheckACLPermissions(RespCommand.CLUSTER, RespCommandsInfo.SubCommandIds.ClusterAddSlotsRange, count, out bool success))
            {
                return success;
            }
        ...
        private bool NetworkClusterCountKeysInSlot(ReadOnlySpan<byte> bufSpan, int count, out bool invalidParameters)
        {
            ...
            if (!CheckACLPermissions(RespCommand.CLUSTER, RespCommandsInfo.SubCommandIds.ClusterCountKeysInSlot, count, out bool success))
            {
                return success;
            }
        ...
        private bool NetworkClusterDelSlots(ReadOnlySpan<byte> bufSpan, int count, out bool invalidParameters)
        {
            ...
            if (!CheckACLPermissions(RespCommand.CLUSTER, RespCommandsInfo.SubCommandIds.ClusterDelSlots, count, out bool success))
            {
                return success;
            }
        ...
        private bool NetworkClusterDelSlotsRange(ReadOnlySpan<byte> bufSpan, int count, out bool invalidParameters)
        {
            ...
            if (!CheckACLPermissions(RespCommand.CLUSTER, RespCommandsInfo.SubCommandIds.ClusterDelSlotsRange, count, out bool success))
            {
                return success;
            }
        ...
        private bool NetworkClusterDelKeysInSlot(ReadOnlySpan<byte> bufSpan, int count, out bool invalidParameters)
        {
            ...
            if (!CheckACLPermissions(RespCommand.CLUSTER, RespCommandsInfo.SubCommandIds.ClusterDelKeysInSlot, count, out bool success))
            {
                return success;
            }
        ...
        private bool NetworkClusterDelKeysInSlotRange(ReadOnlySpan<byte> bufSpan, int count, out bool invalidParameters)
        {
            ...
            if (!CheckACLPermissions(RespCommand.CLUSTER, RespCommandsInfo.SubCommandIds.ClusterDelKeysInSlotRange, count, out bool success))
            {
                return success;
            }
        ...
        private bool NetworkClusterGetKeysInSlot(ReadOnlySpan<byte> bufSpan, int count, out bool invalidParameters)
        {
            ...
            if (!CheckACLPermissions(RespCommand.CLUSTER, RespCommandsInfo.SubCommandIds.ClusterGetKeysInSlot, count, out bool success))
            {
                return success;
            }
        ...
        {
            invalidParameters = false;
            if (!CheckACLPermissions(RespCommand.CLUSTER, RespCommandsInfo.SubCommandIds.ClusterSetSlot, count, out bool success))
            {
                return success;
            }
        ...
        private bool NetworkClusterSetSlotsRange(ReadOnlySpan<byte> bufSpan, int count, out bool invalidParameters)
        {
            ...
            if (!CheckACLPermissions(RespCommand.CLUSTER, RespCommandsInfo.SubCommandIds.ClusterSetSlotsRange, count, out bool success))
            {
                return success;
            }
        ...
        private bool NetworkClusterSlots(ReadOnlySpan<byte> bufSpan, int count, out bool invalidParameters)
        {
            ...
            if (!CheckACLPermissions(RespCommand.CLUSTER, RespCommandsInfo.SubCommandIds.ClusterSlots, count, out bool success))
            {
                return success;
            }
        ...
        private bool NetworkClusterSlotState(ReadOnlySpan<byte> bufSpan, int count, out bool invalidParameters)
        {
            ...
            if (!CheckACLPermissions(RespCommand.CLUSTER, RespCommandsInfo.SubCommandIds.ClusterSlotState, count, out bool success))
            {
                return success;
            }
