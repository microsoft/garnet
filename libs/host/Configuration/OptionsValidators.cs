...
namespace Garnet
{
    ...
    internal sealed class IpAddressValidationAttribute : OptionValidationAttribute
    {
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            {
                if (ipAddress.Equals(Localhost, StringComparison.CurrentCultureIgnoreCase) || Format.TryCreateEndpoint(ipAddress, 0, useForBind: false, logger: logger).Result != null)
                    continue;
