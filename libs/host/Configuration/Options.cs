...
namespace Garnet
{
    ...
    internal sealed class Options
    {
        ...
        [OptionValidation]
        [Option("enable-debug-command", Required = false, HelpText = "Enable DEBUG command for 'no', 'local' or 'all' connections", Hidden = true)]
        public string EnableDebugCommand { get; set; }
        ...
        public GarnetServerOptions GetServerOptions(ILogger logger = null)
        {
            ...
            return new GarnetServerOptions(logger)
            {
                ...
                EnableDebugCommand = ConnectionProtectionOptionExtensions.FromString(EnableDebugCommand),
