...
namespace Garnet
{
    ...
    internal sealed class Options : ICloneable
    {
        ...
        [OptionValidation]
        [Option("on-demand-checkpoint", Required = true, HelpText = "Used with main-memory replication model. Take on demand checkpoint to avoid missing data when attaching")]
