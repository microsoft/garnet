...
namespace Garnet.server
{
    ...
    internal sealed unsafe class ScratchBufferAllocator
    {
        ...
        /// <summary>
        /// View remaining scratch space (of specified minimum length) as an <see cref="ArgSlice"/>.
        /// Does NOT move the offset forward. The returned value is an immediate-use view
        /// that may be invalidated by any subsequent allocation — do not store or return it.
        /// </summary>
        /// <param name="minLength">Minimum length of remaining space</param>
        /// <returns>An <see cref="ArgSlice"/> covering the remaining space</returns>
