...
namespace Garnet.server
{
    ...
    /// </summary>
    public struct UnifiedStoreOutput
    {
        /// <summary>
        ...
        public UnifiedStoreOutput() => SpanByteAndMemory = new(null);

        public UnifiedStoreOutput(SpanByteAndMemory sbam) => SpanByteAndMemory = sbam;

        public static unsafe UnifiedStoreOutput FromPinnedPointer(byte* pointer, int length)
