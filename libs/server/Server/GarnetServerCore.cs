...
namespace Garnet.server
{
    ...
    /// </summary>
    public class GarnetServerCore : IDisposable
    {
        /// <summary>
        ...
        public GarnetServerCore(GarnetServerOptions opts, ILoggerFactory loggerFactory = null, IGarnetServer[] servers = null, bool cleanupDir = false)
        {
        ...
        private GarnetDatabase CreateDatabase(int dbId, GarnetServerOptions serverOptions, IClusterFactory clusterFactory,
