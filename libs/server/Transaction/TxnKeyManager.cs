    ...
    sealed partial class TransactionManager
    {
        ...
        internal int GetKeys(RespCommand command, int inputCount, out ReadOnlySpan<byte> error)
        {
            ...
            return command switch
            {
                ...
                RespCommand.EXPIREAT => SingleKey(1, false, LockType.Exclusive),
                RespCommand.EXPIRETIME => SingleKey(1, false, LockType.Shared),
                ...
                RespCommand.HEXPIRETIME => SingleKey(1, false, LockType.Shared),
                ...
                RespCommand.HPEXPIRETIME => SingleKey(1, false, LockType.Shared),
                RespCommand.HPERSIST => SingleKey(1, false, LockType.Exclusive),
                RespCommand.HPTTL => SingleKey(1, false, LockType.Shared),
                ...
                RespCommand.HTTL => SingleKey(1, false, LockType.Shared),
                ...
                RespCommand.LPOS => SingleKey(1, false, LockType.Shared),
                ...
                RespCommand.PEXPIRETIME => SingleKey(1, false, LockType.Shared),
                ...
                RespCommand.PTTL => SingleKey(1, false, LockType.Shared),
                RespCommand.RENAME => SingleKey(1, false, LockType.Exclusive),
                RespCommand.RENAMENX => SingleKey(1, false, LockType.Exclusive),
                ...
                RespCommand.SCAN => SingleKey(1, false, LockType.Shared),
                ...
                RespCommand.TYPE => SingleKey(1, false, LockType.Shared),
