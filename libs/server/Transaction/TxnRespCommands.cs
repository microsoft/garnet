    ...
    internal sealed unsafe partial class RespServerSession : ServerSessionBase
    {
        ...
        private bool NetworkEXEC()
        {
            ...
            else if (txnManager.state == TxnState.Started)
            {
                ...
                if (NetworkKeyArraySlotVerify(keys, readOnly, isVectorSetWriteCommand: false, keyCount)) // TODO: We should actually verify if commands contained are Vector Set writes
                {
