...
namespace Garnet.server
{
    ...
    {
        private void SetAdd(ref ObjectInput input, ref ObjectStoreOutput output)
        {
        ...
        private void SetMembers(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
        ...
        private void SetIsMember(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            using var writer = new RespMemoryWriter(respProtocolVersion, ref output.SpanByteAndMemory);
        ...
        private void SetMultiIsMember(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            using var writer = new RespMemoryWriter(respProtocolVersion, ref output.SpanByteAndMemory);
        ...
        private void SetRemove(ref ObjectInput input, ref ObjectStoreOutput output)
        {
            for (var i = 0; i < input.parseState.Count; i++)
            {
        ...
        private void SetLength(ref ObjectStoreOutput output)
        {
            // SCARD key
            output.Header.result1 = Set.Count;
        }

        private void SetPop(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            // SPOP key [count]
        ...
        private void SetRandomMember(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            var count = input.arg1;
            var seed = input.arg2;
