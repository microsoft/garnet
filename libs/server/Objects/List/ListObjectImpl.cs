...
namespace Garnet.server
{
    ...
    {
        private void ListRemove(ref ObjectInput input, ref ObjectStoreOutput output)
        {
        ...
        private void ListInsert(ref ObjectInput input, ref ObjectStoreOutput output)
        {
            //indicates partial execution
            output.Header.result1 = int.MinValue;
        ...
        private void ListIndex(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
        ...
        private void ListRange(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
        ...
        private void ListTrim(ref ObjectInput input, ref ObjectStoreOutput output)
        {
            var start = input.arg1;
            var end = input.arg2;
        ...
        private void ListLength(ref ObjectStoreOutput output)
        {
            output.Header.result1 = list.Count;
        }

        private void ListPush(ref ObjectInput input, ref ObjectStoreOutput output, bool fAddAtHead)
        {
            output.Header.result1 = 0;
        ...
        private void ListPop(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion, bool fDelAtHead)
        {
            var count = input.arg1;
        ...
        private void ListSet(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            using var writer = new RespMemoryWriter(respProtocolVersion, ref output.SpanByteAndMemory);
        ...
        private void ListPosition(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
