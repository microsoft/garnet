...
namespace Garnet.server
{
    ...
    public partial class SortedSetObject : GarnetObjectBase
    {
        ...
        private void SortedSetAdd(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            DeleteExpiredItems();
        ...
        private void SortedSetRemove(ref ObjectInput input, ref ObjectStoreOutput output)
        {
            DeleteExpiredItems();
        ...
        private void SortedSetLength(ref ObjectStoreOutput output)
        {
            // Check both objects
        ...
        private void SortedSetScore(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            // ZSCORE key member
        ...
        private void SortedSetScores(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            // ZMSCORE key member
        ...
        private void SortedSetCount(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            // Read min & max
        ...
        private void SortedSetIncrement(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            DeleteExpiredItems();
        ...
        private void SortedSetRange(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
        ...
        private void SortedSetRemoveRangeByRank(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            DeleteExpiredItems();
        ...
        private void SortedSetRemoveRangeByScore(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            DeleteExpiredItems();
        ...
        private void SortedSetRandomMember(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
        ...
        private void SortedSetRemoveOrCountRangeByLex(ref ObjectInput input, ref ObjectStoreOutput output, SortedSetOperation op)
        {
        ...
        private void SortedSetRank(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion, bool ascending = true)
        {
            //ZRANK key member
        ...
        /// <param name="output"></param>
        /// <param name="op"></param>
        private void SortedSetPopMinOrMaxCount(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion, SortedSetOperation op)
        {
            DeleteExpiredItems();
        ...
        private void SortedSetPersist(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            DeleteExpiredItems();
        ...
        private void SortedSetTimeToLive(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            DeleteExpiredItems();
        ...
        private void SortedSetExpire(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            DeleteExpiredItems();
        ...
        private void SortedSetCollect(ref ObjectInput input, ref ObjectStoreOutput output)
        {
            DeleteExpiredItems();
