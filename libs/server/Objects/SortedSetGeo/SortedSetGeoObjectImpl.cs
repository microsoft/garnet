...
namespace Garnet.server
{
    ...
    public partial class SortedSetObject : GarnetObjectBase
    {
        ...
        private void GeoAdd(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            DeleteExpiredItems();
        ...
        private void GeoHash(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            using var writer = new RespMemoryWriter(respProtocolVersion, ref output.SpanByteAndMemory);
        ...
        private void GeoDistance(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            // Read 1st member
        ...
        private void GeoPosition(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
            using var writer = new RespMemoryWriter(respProtocolVersion, ref output.SpanByteAndMemory);
