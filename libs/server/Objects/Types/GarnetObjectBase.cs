...
namespace Garnet.server
{
    ...
    public abstract class GarnetObjectBase : HeapObjectBase, IGarnetObject
    {
        ...
        /// <inheritdoc />
        public abstract bool Operate(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion, out long sizeChange);
        ...
        protected unsafe void Scan(ref ObjectInput input, ref ObjectStoreOutput output, byte respProtocolVersion)
        {
