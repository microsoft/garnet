    ...
    internal sealed unsafe partial class RespServerSession : ServerSessionBase
    {
            ...
            where TGarnetApi : IGarnetAdvancedApi
        {
            ...
            if (customCommand.type == CommandType.ReadModifyWrite)
            {
                ...
                {
                    output = scratchBufferAllocator.CreateArgSlice(_output.AsReadOnlySpan());
            ...
            if (customObjCommand.type == CommandType.ReadModifyWrite)
            {
                ...
                switch (status)
                {
                    ...
                    default:
                        ...
                        {
                            output = scratchBufferAllocator.CreateArgSlice(_output.SpanByteAndMemory.AsReadOnlySpan());
