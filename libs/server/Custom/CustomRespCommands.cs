...
namespace Garnet.server
{
    ...
    internal sealed unsafe partial class RespServerSession : ServerSessionBase
    {
        ...
        public bool RunTransactionProc(byte id, ref CustomProcedureInput procInput, ref MemoryResult<byte> output, bool isRecovering = false, CustomProcKeyHashTracker customProcTimestampBitmap = null)
        {
