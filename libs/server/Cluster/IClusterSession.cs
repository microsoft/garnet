...
namespace Garnet.server
{
    ...
    public interface IClusterSession
    {
        ...
        /// </summary>
        unsafe bool NetworkKeyArraySlotVerify(Span<ArgSlice> keys, bool readOnly, byte SessionAsking, bool isVectorSetWriteCommand, ref byte* dcurr, ref byte* dend, int count = -1);
