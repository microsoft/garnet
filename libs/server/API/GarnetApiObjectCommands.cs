...
namespace Garnet.server
{
        ...
        where TUnifiedContext : ITsavoriteContext<UnifiedStoreInput, UnifiedStoreOutput, long, UnifiedSessionFunctions, StoreFunctions, StoreAllocator>
    {
        ...
        /// <inheritdoc />
        public GarnetStatus SortedSetAdd(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus SortedSetRange(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
            => storageSession.SortedSetRange(key, ref input, ref output, ref objectContext);

        /// <inheritdoc />
        public GarnetStatus SortedSetScore(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
            => storageSession.SortedSetScore(key, ref input, ref output, ref objectContext);

        /// <inheritdoc />
        public GarnetStatus SortedSetScores(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
            => storageSession.SortedSetScores(key, ref input, ref output, ref objectContext);

        /// <inheritdoc />
        public GarnetStatus SortedSetPop(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus SortedSetCount(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus SortedSetIncrement(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus SortedSetRemoveRange(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
            => storageSession.SortedSetRemoveRange(key, ref input, ref output, ref objectContext);

        /// <inheritdoc />
        public GarnetStatus SortedSetRank(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus SortedSetRandomMember(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus SortedSetExpire(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus SortedSetPersist(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus SortedSetTimeToLive(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus GeoAdd(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
            => storageSession.GeoAdd(key, ref input, ref output, ref objectContext);

        /// <inheritdoc />
        public GarnetStatus GeoCommands(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus ListPosition(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
            => storageSession.ListPosition(key, ref input, ref output, ref objectContext);

        /// <inheritdoc />
        public GarnetStatus ListLeftPop(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus ListRightPop(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
            => storageSession.ListPop(key, ref input, ref output, ref objectContext);
        ...
        /// <inheritdoc />
        public GarnetStatus ListRange(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus ListIndex(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus ListSet(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus SetMembers(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
            => storageSession.SetMembers(key, ref input, ref output, ref objectContext);

        /// <inheritdoc />
        public GarnetStatus SetIsMember(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus SetPop(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
            => storageSession.SetPop(key, ref input, ref output, ref objectContext);

        /// <inheritdoc />
        public GarnetStatus SetRandomMember(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus HashGet(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        => storageSession.HashGet(key, ref input, ref output, ref objectContext);

        /// <inheritdoc />
        public GarnetStatus HashGetAll(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
            => storageSession.HashGetAll(key, ref input, ref output, ref objectContext);

        /// <inheritdoc />
        public GarnetStatus HashGetMultiple(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus HashRandomField(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus HashKeys(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
            => storageSession.HashKeys(key, ref input, ref output, ref objectContext);

        /// <inheritdoc />
        public GarnetStatus HashVals(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus HashIncrement(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
            => storageSession.HashIncrement(key, ref input, ref output, ref objectContext);

        /// <inheritdoc />
        public GarnetStatus HashExpire(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
            => storageSession.HashExpire(key, ref input, ref output, ref objectContext);

        /// <inheritdoc />
        public GarnetStatus HashPersist(PinnedSpanByte key, ref ObjectInput input, ref ObjectStoreOutput output)
        ...
        /// <inheritdoc />
        public GarnetStatus HashTimeToLive(PinnedSpanByte key, bool isMilliseconds, bool isTimestamp, ref ObjectInput input, ref ObjectStoreOutput output)
