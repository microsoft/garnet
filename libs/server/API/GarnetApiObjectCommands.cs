...
namespace Garnet.server
{
        ...
        where TUnifiedContext : ITsavoriteContext<FixedSpanByteKey, UnifiedInput, UnifiedOutput, long, UnifiedSessionFunctions, StoreFunctions, StoreAllocator>
    {
        ...
        /// <inheritdoc />
        public GarnetStatus SortedSetRangeStore(PinnedSpanByte dstKey, PinnedSpanByte srcKey, ref ObjectInput input, ref SpanByteAndMemory output)
            => storageSession.SortedSetRangeStore(dstKey, srcKey, ref input, ref output, ref objectContext);
