...
namespace Garnet.server
{
    ...
    static partial class CmdStrings
    {
        ...
        public static ReadOnlySpan<byte> slave => "slave"u8;
        public static ReadOnlySpan<byte> ERR_transaction_failed => "ERR Transaction failed."u8;
        public static ReadOnlySpan<byte> ERR_command_failed => "ERR Command failed."u8;
        public static ReadOnlySpan<byte> flags => "flags"u8;
        public static ReadOnlySpan<byte> passwords => "passwords"u8;
        public static ReadOnlySpan<byte> commands => "commands"u8;
        public static ReadOnlySpan<byte> AOF_file_committed => "AOF file committed"u8;
        public static ReadOnlySpan<byte> GC_completed => "GC completed"u8;
        public static ReadOnlySpan<byte> Background_saving_started => "Background saving started"u8;
        public static ReadOnlySpan<byte> none => "none"u8;
        public static ReadOnlySpan<byte> ERR_Client_sent_AUTH_no_pass => "ERR Client sent AUTH, but configured authenticator does not accept passwords"u8;
        public static ReadOnlySpan<byte> modules => "modules"u8;
        public static ReadOnlySpan<byte> ERR_RESTORE_currently_only_supports => "ERR RESTORE currently only supports string types"u8;
        public static ReadOnlySpan<byte> ERR_DUMP_payload_version_or_checksum_wrong => "ERR DUMP payload version or checksum are wrong"u8;
        public static ReadOnlySpan<byte> ERR_DUMP_payload_length_format_invalid => "ERR DUMP payload length format is invalid"u8;
        public static ReadOnlySpan<byte> ERR_DUMP_payload_length_is_invalid => "ERR DUMP payload length is invalid"u8;
        public static ReadOnlySpan<byte> ERR_NX_and_XX_GT_or_LT_not_compatible => "ERR NX and XX, GT or LT options at the same time are not compatible"u8;
        public static ReadOnlySpan<byte> message => "message"u8;
        public static ReadOnlySpan<byte> pmessage => "pmessage"u8;
        public static ReadOnlySpan<byte> ERR_SUBSCRIBE_is_disabled => "ERR SUBSCRIBE is disabled, enable it with --pubsub option."u8;
        public static ReadOnlySpan<byte> psubscribe => "psubscribe"u8;
        public static ReadOnlySpan<byte> unsubscribe => "unsubscribe"u8;
        public static ReadOnlySpan<byte> ERR_UNSUBSCRIBE_is_disabled => "ERR UNSUBSCRIBE is disabled, enable it with --pubsub option."u8;
        public static ReadOnlySpan<byte> punsubscribe => "punsubscribe"u8;
        public static ReadOnlySpan<byte> ERR_PUNSUBSCRIBE_is_disabled => "ERR PUNSUBSCRIBE is disabled, enable it with --pubsub option."u8;
        public static ReadOnlySpan<byte> ERR_Vector_exceeded_configured_page_size => "ERR Vector exceed configured page size"u8;
        public static ReadOnlySpan<byte> ERR_Unsupported_quantization_type => "ERR Unsupported quantization type"u8;
        public static ReadOnlySpan<byte> ERR_Element_not_in_Vector_Set => "ERR Element not in Vector Set"u8;
        public static ReadOnlySpan<byte> ERR_Key_not_found => "ERR Key not found"u8;
        public static ReadOnlySpan<byte> quant_type => "quant-type"u8;
        public static ReadOnlySpan<byte> distance_metric => "distance-metric"u8;
        public static ReadOnlySpan<byte> input_vector_dimensions => "input-vector-dimensions"u8;
        public static ReadOnlySpan<byte> reduced_dimensions => "reduced-dimensions"u8;
        public static ReadOnlySpan<byte> build_exploration_factor => "build-exploration-factor"u8;
