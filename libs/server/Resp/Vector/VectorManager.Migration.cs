    ...
    public sealed partial class VectorManager
    {
            ...
            ref SpanByte value)
        {
            ...
            if (ActiveThreadSession == null)
            {
                ...
                ActiveThreadSession = newStorageSession = new StorageSession(storeWrapper, new(), new ScratchBufferAllocator(), null, null, db.Id, this, this.logger);
            }
            else
            {
        ...
        public unsafe HashSet<ulong> GetNamespacesForKeys(StoreWrapper storeWrapper, IEnumerable<byte[]> keys, Dictionary<byte[], byte[]> vectorSetKeys)
        {
            ...
            using var storageSession = new StorageSession(storeWrapper, new(), new ScratchBufferAllocator(), null, null, storeWrapper.DefaultDatabase.Id, this, logger);
