    ...
    internal sealed unsafe partial class RespServerSession : ServerSessionBase
    {
            ...
            where TGarnetApi : IGarnetApi
        {
            ...
            while (currCount < parseState.count)
            {
                ...
                var sign = encodingArg.StartsWith("i", StringComparison.OrdinalIgnoreCase) ? (byte)BitFieldSign.SIGNED : (byte)BitFieldSign.UNSIGNED;
                ...
                var offsetType = offsetArg.StartsWith("#", StringComparison.Ordinal);
            ...
            where TGarnetApi : IGarnetApi
        {
            ...
            while (currCount < parseState.count)
            {
                ...
                // Identify sign for number
                var sign = encoding.StartsWith("i", StringComparison.OrdinalIgnoreCase) ? (byte)BitFieldSign.SIGNED : (byte)BitFieldSign.UNSIGNED;
                // Number of bits in signed number
