...
namespace Garnet.server
{
    ...
    internal sealed unsafe partial class RespServerSession : ServerSessionBase
    {
            ...
            where TGarnetApi : IGarnetApi
        {
            ...
            var input = new RawStringInput(RespCommand.SETBIT, ref parseState, startIdx: 1, metaCommand, ref metaCommandParseState, arg1: offset);
            ...
            where TGarnetApi : IGarnetApi
        {
            ...
            var input = new RawStringInput(RespCommand.GETBIT, ref parseState, startIdx: 1, metaCommand, ref metaCommandParseState, arg1: offset);
            ...
            where TGarnetApi : IGarnetApi
        {
            ...
            var input = new RawStringInput(RespCommand.BITCOUNT, ref parseState, startIdx: 1, metaCommand, ref metaCommandParseState);
            ...
            where TGarnetApi : IGarnetApi
        {
            ...
            var input = new RawStringInput(RespCommand.BITPOS, ref parseState, startIdx: 1, metaCommand, ref metaCommandParseState);
            ...
            where TGarnetApi : IGarnetApi
        {
            ...
            var input = new RawStringInput(RespCommand.BITOP, ref parseState, metaCommand, ref metaCommandParseState);
