...
namespace Garnet.server
{
    ...
    internal
        ...
        ref
#endif
        struct MGetReadArgBatch<TGarnetApi>(ref TGarnetApi storageApi, RespServerSession session) : IReadArgBatch<SpanByteKey, StringInput, StringOutput>
        where TGarnetApi : IGarnetAdvancedApi
    {
        ...
        /// <inheritdoc/>
        public readonly void GetKey(int i, out SpanByteKey key)
        => key = (SpanByteKey)session.parseState.GetArgSliceByRef(i).ReadOnlySpan;
    ...
    /// </summary>
    internal struct MGetReadArgBatch_SG(RespServerSession session) : IReadArgBatch<SpanByteKey, StringInput, StringOutput>
    {
