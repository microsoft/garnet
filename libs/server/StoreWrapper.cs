...
namespace Garnet.server
{
    ...
    public sealed class StoreWrapper
    {
        ...
        /// AOF (of DB 0)
        /// </summary>
        public IAppendOnlyFile appendOnlyFile => databaseManager.AppendOnlyFile;
        ...
        /// </summary>
        public IAofAddress ReplayAOF(IAofAddress untilAddress = default) => this.databaseManager.ReplayAOF(untilAddress);
