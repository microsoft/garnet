...
namespace Garnet.server
{
    sealed partial class StorageSession : IDisposable
    {
        ...
        /// <returns></returns>
        public static GarnetStatus GeoAdd<TObjectContext>(byte[] key, ArgSlice input, out ObjectOutputHeader output, ref TObjectContext objectContext)
        ...
        /// <param name="objectContext"></param>
        /// <returns></returns>
        public static GarnetStatus GeoCommands<TObjectContext>(byte[] key, ArgSlice input, ref GarnetObjectStoreOutput outputFooter, ref TObjectContext objectContext)
            where TObjectContext : ITsavoriteContext<byte[], IGarnetObject, SpanByte, GarnetObjectStoreOutput, long>
