...
#pragma warning disable IDE0065 // Misplaced using directive
    ...
    public readonly unsafe partial struct UnifiedSessionFunctions : ISessionFunctions<UnifiedStoreInput, UnifiedStoreOutput, long>
    {
        public bool Reader<TSourceLogRecord>(in TSourceLogRecord srcLogRecord, ref UnifiedStoreInput input,
            ref UnifiedStoreOutput output, ref ReadInfo readInfo) where TSourceLogRecord : ISourceLogRecord
        {
        ...
        private bool HandleMemoryUsage<TSourceLogRecord>(in TSourceLogRecord srcLogRecord,
            ref UnifiedStoreOutput output) where TSourceLogRecord : ISourceLogRecord
        {
        ...
        private bool HandleTtl<TSourceLogRecord>(in TSourceLogRecord srcLogRecord,
            ref UnifiedStoreOutput output, bool milliseconds) where TSourceLogRecord : ISourceLogRecord
        {
            using var writer = new RespMemoryWriter(functionsState.respProtocolVersion, ref output.SpanByteAndMemory);
        ...
        private bool HandleMigrate<TSourceLogRecord>(in TSourceLogRecord srcLogRecord, int maxHeapAllocationSize, ref UnifiedStoreOutput output)
        ...
        private bool HandleRename<TSourceLogRecord>(in TSourceLogRecord srcLogRecord, ref UnifiedStoreOutput output)
            where TSourceLogRecord : ISourceLogRecord
        {
