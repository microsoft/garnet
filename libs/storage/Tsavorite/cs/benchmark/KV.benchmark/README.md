...
**Disk-IO thread-scale sweep — what to look for**: the last three rows above
load 100 M × 100 B records (≈ 12.8 GB on disk) with a 16 MB log so that
roughly **0.125 %** of the dataset is in memory at any time. Every read
