    ...
    internal class SpanByteTests
    {
        ...
        public unsafe void SpanByteTest1()
        {
            ...
            try
            {
                ...
                using var store = new TsavoriteKV<SpanByte, SpanByte>
                    (128, new LogSettings { LogDevice = log, MemorySizePages = 1 << 5, PageSizeBits = 12 });
        ...
        public unsafe void MultiRead_SpanByte_Test()
        {
            ...
            try
            {
                ...
                using var store = new TsavoriteKV<SpanByte, SpanByte>(
                    size: 1L << 10,
                    new LogSettings { LogDevice = log, MemorySizePages = 1 << 3, PageSizeBits = 12 });
        ...
        public unsafe void ShouldSkipEmptySpaceAtEndOfPage()
        {
            ...
            using var store = new TsavoriteKV<SpanByte, SpanByte>
                (128,
                new LogSettings { LogDevice = log, MemorySizePages = 1 << 7, PageSizeBits = 10 }, // 1KB page
