    ...
    internal class SpanByteLogScanTests
    {
        ...
        public void Setup()
        {
            ...
            store = new TsavoriteKV<SpanByte, SpanByte>
                (1L << 20, new LogSettings { LogDevice = log, MemorySizePages = 1 << (25 - PageSizeBits), PageSizeBits = PageSizeBits }, concurrencyControlMode: ConcurrencyControlMode.None, comparer: comparer);
        }
        ...
        public unsafe void SpanByteJumpToBeginAddressTest()
        {
            ...
            using var store = new TsavoriteKV<SpanByte, SpanByte>
                (1L << 20, new LogSettings { LogDevice = log, MemorySizePages = 1 << 5, PageSizeBits = 15 }, concurrencyControlMode: ConcurrencyControlMode.None);
