...
namespace Tsavorite.test.ModifiedBit
{
    ...
    class ModifiedBitTests
    {
        ...
        public void Setup()
        {
            ...
            store = new TsavoriteKV<int, int>(1L << 20, new LogSettings { LogDevice = log, ObjectLogDevice = null, PageSizeBits = 12, MemorySizePages = 1 << 10 }, comparer: comparer, concurrencyControlMode: ConcurrencyControlMode.LockTable);
