...
namespace Tsavorite.test
{
    ...
    internal class GenericLogScanTests
    {
        ...
        public void DiskWriteScanBasicTest([Values] DeviceType deviceType, [Values] ScanIteratorType scanIteratorType)
        {
            ...
            store = new(128,
                      logSettings: new LogSettings { LogDevice = log, ObjectLogDevice = objlog, MutableFraction = 0.1, MemorySizePages = 1 << 6, PageSizeBits = 9, SegmentSizeBits = 22 },
        ...
        public void BlittableScanJumpToBeginAddressTest()
        {
            ...
            store = new(128,
                      logSettings: new LogSettings { LogDevice = log, ObjectLogDevice = objlog, MutableFraction = 0.1, MemorySizePages = 1 << 5, PageSizeBits = 15, SegmentSizeBits = 18 },
                      serializerSettings: new SerializerSettings<MyKey, MyValue> { keySerializer = () => new MyKeySerializer(), valueSerializer = () => new MyValueSerializer() },
