...
namespace Tsavorite.test.LowMemory
{
    ...
    [TestFixture]
    public class LowMemoryTests : TestBase
    {
        IDevice log;
        ...
        public void Setup()
        {
            ...
            log = new LocalMemoryDevice(1L << 28, 1L << 25, 1, latencyUs: DefaultLocalMemoryDeviceLatencyUs, fileName: Path.Join(MethodTestDir, "test.log"));
