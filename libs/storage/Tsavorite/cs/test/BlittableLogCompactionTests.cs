    ...
    public class BlittableLogCompactionTests
    {
        ...
        public void Setup()
        {
            ...
            store = new TsavoriteKV<KeyStruct, ValueStruct>
                (1L << 20, new LogSettings { LogDevice = log, MemorySizePages = 1 << 6, PageSizeBits = 9 }, comparer: new HashModuloComparer(hashMod), concurrencyControlMode: concurrencyControlMode); ;
        }
