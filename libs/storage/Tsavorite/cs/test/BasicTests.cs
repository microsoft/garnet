...
namespace Tsavorite.test
{
    ...
    internal class BasicTests
    {
        ...
        {
            Setup(128, new LogSettings { PageSizeBits = 10, MemorySizePages = 1 << 2, SegmentSizeBits = 22 }, deviceType);
        ...
        public void NativeInMemWriteReadDelete2()
        {
            ...
            Setup(128, new LogSettings { MemorySizePages = 1 << 4 }, deviceType);
        ...
        public unsafe void TestShiftHeadAddress([Values] DeviceType deviceType, [Values] BatchMode batchMode)
        {
            ...
            Setup(128, new LogSettings { MemorySizePages = 1 << 12, SegmentSizeBits = 22, PageSizeBits = 10 }, deviceType, latencyMs: latencyMs);
        ...
        public unsafe void NativeInMemRMWRefKeys([Values] DeviceType deviceType)
        {
            ...
            Setup(128, new LogSettings { MemorySizePages = 1 << 12, SegmentSizeBits = 22, PageSizeBits = 10 }, deviceType);
        ...
        public void ReadAtAddressIgnoreReadCache()
        {
            ...
            Setup(128, new LogSettings { MemorySizePages = 1 << 4, ReadCacheSettings = new ReadCacheSettings() }, deviceType);
