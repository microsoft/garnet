...
namespace Tsavorite.test
{
    ...
    class ObjectIdMapTests
    {
        ...
        public unsafe void ObjectIdMapTest1([Values(1, 8)] int numThreads)
        {
            ...
            Assert.That(map.freeList.Count, Is.EqualTo(MultiLevelPageArray.ChapterSize * numThreads), "All freed items should have been added to the the freeList elementArray"); ;
            Assert.That(map.freeList.stack.IsNil, Is.False, "All freed items should be in the stack");
            Assert.That(map.freeList.freeList.IsNil, Is.True, "No freed items should be in the freeList");
            ...
            Assert.That(map.freeList.freeList.IsNil, Is.False, "All freed items should be in the freeList");
