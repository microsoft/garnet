    ...
    internal class BlittableLogScanTests
    {
        ...
        public void Setup()
        {
            ...
            store = new TsavoriteKV<KeyStruct, ValueStruct>(1L << 20,
                new LogSettings { LogDevice = log, MemorySizePages = 1 << (24 - PageSizeBits), PageSizeBits = PageSizeBits }, concurrencyControlMode: ConcurrencyControlMode.None, comparer: comparer);
        }
