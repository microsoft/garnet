...
namespace Tsavorite.core
{
    ...
    public static class Devices
    {
        ...
        /// <param name="logger"></param>
        /// <returns>Device instance</returns>
        public static IDevice CreateDevice(string logPath, bool preallocateFile = false, bool deleteOnClose = false, long capacity = CAPACITY_UNSPECIFIED, bool recoverDevice = false, bool useIoCompletionPort = false, bool disableFileBuffering = true, DeviceType deviceType = DeviceType.Native, bool readOnly = false, ILogger logger = null)
        {
            return deviceType switch
            {
                ...
                _ => throw new TsavoriteException("Unsupported local device"),
            };
        }
    }
}