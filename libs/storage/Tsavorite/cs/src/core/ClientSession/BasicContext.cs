...
namespace Tsavorite.core
{
        ...
        where TAllocator : IAllocator<TStoreFunctions>
    {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void ReadWithPrefetch<TKey, TBatch>(ref TBatch batch, TContext userContext = default)
            where TKey : IKey
#if NET9_0_OR_GREATER
            , allows ref struct
#endif
...
#endif
        {
            ...
            try
            {
                clientSession.store.ContextReadWithPrefetch<TKey, TBatch, TInput, TOutput, TContext, SessionFunctionsWrapper<TInput, TOutput, TContext, TFunctions, BasicSessionLocker<TStoreFunctions, TAllocator>, TStoreFunctions, TAllocator>>(ref batch, userContext, sessionFunctions);
            }
            finally
            {
                UnsafeSuspendThread();
        ...
        public Status RMW<TKey>(TKey key, ref TInput input, ref TOutput output, TContext userContext = default)
            ...
            , allows ref struct
#endif
            => RMW(key, key.GetKeyHashCode64(), ref input, ref output, out _, userContext);
...
#endif
        {
            var keyHash = rmwOptions.KeyHash ?? key.GetKeyHashCode64();
            return RMW(key, keyHash, ref input, ref output, out recordMetadata, userContext);
        }

        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private Status RMW<TKey>(TKey key, long keyHash, ref TInput input, ref TOutput output, out RecordMetadata recordMetadata, TContext userContext = default)
            where TKey : IKey
#if NET9_0_OR_GREATER
            , allows ref struct
#endif
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private Status Delete<TKey>(TKey key, long keyHash, TContext userContext = default)
            where TKey : IKey
#if NET9_0_OR_GREATER
            , allows ref struct
#endif
        {
            ...
            try
            {
                return store.ContextDelete<TKey, TInput, TOutput, TContext, SessionFunctionsWrapper<TInput, TOutput, TContext, TFunctions, BasicSessionLocker<TStoreFunctions, TAllocator>, TStoreFunctions, TAllocator>>(key, keyHash, userContext, sessionFunctions);
            }
            finally
            {
                UnsafeSuspendThread();
        ...
        public Status ContainsKeyInMemory<TKey>(TKey key, out long logicalAddress, long fromAddress = -1)   // TODO: remove when we remove tempkv/tempdb in iterators
            where TKey : IKey
#if NET9_0_OR_GREATER
            , allows ref struct
#endif
        {
            ...
            try
            {
                return store.InternalContainsKeyInMemory<TKey, TInput, TOutput, TContext, SessionFunctionsWrapper<TInput, TOutput, TContext, TFunctions, BasicSessionLocker<TStoreFunctions, TAllocator>, TStoreFunctions, TAllocator>>(
