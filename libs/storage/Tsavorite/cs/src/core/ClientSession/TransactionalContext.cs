...
namespace Tsavorite.core
{
        ...
        where TAllocator : IAllocator<TStoreFunctions>
    {
        ...
        internal TransactionalContext(ClientSession<TKey, TInput, TOutput, TContext, TFunctions, TStoreFunctions, TAllocator> clientSession)
        {
        ...
        internal static bool DoTransactionalLock<TSessionFunctionsWrapper, TTransactionalKey>(TSessionFunctionsWrapper sessionFunctions,
                ClientSession<TKey, TInput, TOutput, TContext, TFunctions, TStoreFunctions, TAllocator> clientSession, ReadOnlySpan<TTransactionalKey> keys)
        ...
        internal static bool DoTransactionalTryLock<TSessionFunctionsWrapper, TTransactionalKey>(TSessionFunctionsWrapper sessionFunctions,
                ClientSession<TKey, TInput, TOutput, TContext, TFunctions, TStoreFunctions, TAllocator> clientSession,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static bool DoManualTryPromoteLock<TSessionFunctionsWrapper, TTransactionalKey>(TSessionFunctionsWrapper sessionFunctions, ClientSession<TKey, TInput, TOutput, TContext, TFunctions, TStoreFunctions, TAllocator> clientSession,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static OperationStatus DoTransactionalLock<TTransactionalKey>(ClientSession<TKey, TInput, TOutput, TContext, TFunctions, TStoreFunctions, TAllocator> clientSession, TTransactionalKey key)
            where TTransactionalKey : ITransactionalKey
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static void DoTransactionalUnlock<TTransactionalKey>(ClientSession<TKey, TInput, TOutput, TContext, TFunctions, TStoreFunctions, TAllocator> clientSession,
