...
{
    /// <summary>
    /// This class is created by <see cref="TsavoriteKV{TValue, TStoreFunctions, TAllocator}"/> to pass parameters to the allocator factory function.
    /// </summary>
    public struct AllocatorSettings
    {
        ...
        /// <summary>The epoch created for the <see cref="TsavoriteKV{TValue, TStoreFunctions, TAllocator}"/></summary>
        internal LightEpoch epoch;

        /// <summary>The logger to use, either from <see cref="KVSettings"/> or created by <see cref="TsavoriteKV{TValue, TStoreFunctions, TAllocator}"/></summary>
