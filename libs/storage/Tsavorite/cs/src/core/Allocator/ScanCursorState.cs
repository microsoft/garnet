...
{
    internal sealed class ScanCursorState<TValue>
    {
        internal IScanIteratorFunctions<TValue> functions;
        ...
        internal void Initialize(IScanIteratorFunctions<TValue> scanIteratorFunctions)
        {
