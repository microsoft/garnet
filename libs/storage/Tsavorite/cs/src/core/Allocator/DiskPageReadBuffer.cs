...
#pragma warning disable IDE0065 // Misplaced using directive
    ...
    internal sealed unsafe class DiskPageReadBuffer : IDisposable
    {
        ...
        /// <summary>Set by <see cref="CircularDiskPageReadBuffer"/> for the last chunk to read. This also indicates we may have the optionals in that read.</summary>
        internal bool isLastChunk;

        /// <summary>Set by <see cref="CircularDiskPageReadBuffer"/> for the last chunk to read, if there is enough room on the page to read all the optionals as well.
        ...
        internal DiskPageReadBuffer(SectorAlignedMemory memory, IDevice device, ILogger logger)
        {
            this.memory = memory;
        ...
        /// <param name="callback">The <see cref="CircularDiskPageReadBuffer"/> callback.</param>
        ...
        internal static void IncrementOrResetCountdown(ref CountdownEvent countdownEvent) => DiskPageWriteBuffer.IncrementOrResetCountdown(ref countdownEvent);
