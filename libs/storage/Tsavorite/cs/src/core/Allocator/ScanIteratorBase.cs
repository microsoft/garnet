...
namespace Tsavorite.core
{
    ...
    public abstract class ScanIteratorBase
    {
        ...
        private protected readonly int logPageSizeBits;
        ...
        /// <param name="initForReads">If true, set up frames for reading; false for the DeltaLog, which calls <see cref="InitializeForReads"/> separately unless it is being used to create the snapshot checkpoint</param>
