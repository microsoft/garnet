...
namespace Tsavorite.core
{
    ...
    /// </summary>
    class StreamingSnapshotCheckpointStateMachine<TValue, TStoreFunctions, TAllocator> : VersionChangeStateMachine<TValue, TStoreFunctions, TAllocator>
        ...
        where TAllocator : IAllocator<TValue, TStoreFunctions>
    {
        ...
        public StreamingSnapshotCheckpointStateMachine(long targetVersion)
            : base(targetVersion,
                  new VersionChangeTask<TValue, TStoreFunctions, TAllocator>(),
                  new StreamingSnapshotCheckpointTask<TValue, TStoreFunctions, TAllocator>(targetVersion))
        { }
