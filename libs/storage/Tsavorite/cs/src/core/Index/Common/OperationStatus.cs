...
namespace Tsavorite.core
{
    ...
    internal enum OperationStatus
    {
        ...
        /// <summary>
        /// I/O has been enqueued and the caller must go through <see cref="ITsavoriteContext{TValue, TInput, TOutput, TContext, TFunctions, TStoreFunctions, TAllocator}.CompletePending(bool, bool)"/> or
        /// <see cref="ITsavoriteContext{TValue, TInput, TOutput, TContext, TFunctions, TStoreFunctions, TAllocator}.CompletePendingWithOutputs(out CompletedOutputIterator{TValue, TInput, TOutput, TContext}, bool, bool)"/>,
        ...
        /// <list type="bullet">
        ///   <item>For Sync operations we retry this as part of <see cref="TsavoriteKV{TValue, TStoreFunctions, TAllocator}.HandleImmediateRetryStatus{TInput, TOutput, TContext, TSessionFunctionsWrapper}(OperationStatus, TSessionFunctionsWrapper, ref TsavoriteKV{TValue, TStoreFunctions, TAllocator}.PendingContext{TInput, TOutput, TContext})"/>.</item>
