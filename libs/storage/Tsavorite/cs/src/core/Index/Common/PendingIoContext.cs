...
namespace Tsavorite.core
{
        ...
        where TAllocator : IAllocator<TStoreFunctions>
    {
        ...
        /// fields the allocator/completion path uses) plus the session-typed <see cref="baseOperationState"/>
        /// (in-memory hot-path bookkeeping) and <see cref="pendingState"/> (the pending-only payload carrying the
        ...
        /// drain downcasts to reach <see cref="baseOperationState"/> and <see cref="pendingState"/>.
        /// </summary>
        internal sealed class PendingIoContext<TInput, TOutput, TContext> : AsyncIOContext
        {
            ...
            internal OperationState<TInput, TOutput, TContext> baseOperationState;
            ...
            internal PendingState<TInput, TOutput, TContext> pendingState;
        }
    }
}