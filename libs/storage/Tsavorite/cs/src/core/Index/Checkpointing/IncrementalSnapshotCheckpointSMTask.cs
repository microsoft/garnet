...
namespace Tsavorite.core
{
    ...
    /// </summary>
    internal sealed class IncrementalSnapshotCheckpointSMTask<TValue, TStoreFunctions, TAllocator> : HybridLogCheckpointSMTask<TValue, TStoreFunctions, TAllocator>
        where TStoreFunctions : IStoreFunctions<TValue>
        where TAllocator : IAllocator<TValue, TStoreFunctions>
    {
        public IncrementalSnapshotCheckpointSMTask(TsavoriteKV<TValue, TStoreFunctions, TAllocator> store, Guid guid)
            : base(store, guid)
        {
        }
