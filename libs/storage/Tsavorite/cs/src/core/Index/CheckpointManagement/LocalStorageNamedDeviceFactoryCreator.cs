...
namespace Tsavorite.core
{
    ...
    public class LocalStorageNamedDeviceFactoryCreator : INamedDeviceFactoryCreator
    {
        ...
        {
            return new LocalStorageNamedDeviceFactory(preallocateFile, deleteOnClose, disableFileBuffering, throttleLimit, deviceType, ioBackend, numCompletionThreads, numIoContexts, queueDepth, uringSqPoll, uringSqPollIdleMs, readOnly, baseName, logger);
        }
    }
}