...
internal sealed class TsavoriteKVScanIterator<TKey, TValue, TInput, TOutput, TContext, TFunctions, TStoreFunctions, TAllocator> : ITsavoriteScanIteratorWithPush<TKey, TValue>
    ...
    where TAllocator : IAllocator<TKey, TValue, TStoreFunctions>
{
    ...
    public TsavoriteKVScanIterator(TsavoriteKV<TKey, TValue, TStoreFunctions, TAllocator> store, TFunctions functions, long untilAddress, ILoggerFactory loggerFactory = null)
    {
        this.store = store;
