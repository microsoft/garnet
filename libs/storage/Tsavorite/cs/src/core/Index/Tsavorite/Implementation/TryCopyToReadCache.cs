            ...
            where TSourceLogRecord : ISourceLogRecord
        {
            ...
            if (success && stackCtx.recSrc.LowestReadCacheLogicalAddress != kInvalidAddress)
            {
                ...
                if (stackCtx.hei.IsReadCache)
                {
                    ...
                    success = EnsureNoNewMainLogRecordWasSpliced(inputLogRecord.Key, inputLogRecord.Namespace, ref stackCtx, pendingContext.initialLatestLogicalAddress, ref failStatus);
                }
            }
