...
namespace Tsavorite.core
{
        ...
        where TAllocator : IAllocator<TStoreFunctions>
    {
        ...
        private bool VerifyInMemoryAddresses(ref OperationStackContext<TStoreFunctions, TAllocator> stackCtx)
        {
            ...
            if (!UseReadCache || stackCtx.recSrc.LowestReadCacheLogicalAddress == kInvalidAddress || SetIsInLogMemory(stackCtx.recSrc.LowestReadCacheLogicalAddress) >= readCacheBase.HeadAddress)
                return true;
