...
- **🚀 [Vector Sets (Preview)](https://microsoft.github.io/garnet/docs/dev/vector-sets)** — Approximate nearest-neighbor search backed by the [DiskANN](https://github.com/microsoft/DiskANN) algorithm and Garnet's Tsavorite storage engine. In a [public head-to-head benchmark](https://github.com/microsoft/DiskANN/wiki/Perf:-Garnet-Providers-vs-other-Vector-DBs-(Zilliz,-Pinecone,-etc.)), Garnet leads on QPS, p99 latency, and recall.
