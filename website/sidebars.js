...
const sidebars = {
  ...
  tutorialSidebar: [{type: 'autogenerated', dirName: '.'}],
	...
	garnetDocSidebar: [
		...
		{type: 'category', label: 'Commands', items: ["commands/overview", "commands/api-compatibility", "commands/raw-string", "commands/generic-commands", "commands/analytics-commands", "commands/data-structures", "commands/range-index", "commands/vector-sets", "commands/server-commands", "commands/client-commands", "commands/checkpoint-commands", "commands/transactions-commands", "commands/cluster", "commands/acl-commands", "commands/scripting-commands", "commands/garnet-specific-commands", "commands/json"]},
		...
		{type: 'category', label: 'Tsavorite - Storage Layer', collapsed: true, items: ["dev/tsavorite/intro", "dev/tsavorite/reviv", "dev/tsavorite/locking", "dev/tsavorite/readcache", "dev/tsavorite/storefunctions", "dev/tsavorite/epochprotection", "dev/tsavorite/state-machine", "dev/tsavorite/logrecord", "dev/tsavorite/object-allocator", "dev/tsavorite/buffer-pool", "dev/tsavorite/checkpoint-recovery"]},
