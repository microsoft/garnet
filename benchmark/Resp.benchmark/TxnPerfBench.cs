...
namespace Resp.benchmark
{
    ...
    public class TxnPerfBench
    {
        ...
        public void LoadData()
        {
            ...
            GarnetClientSession client = new(address, port, NetworkBuffers.Default, opts.EnableTLS ? BenchUtils.GetTlsOptions(opts.TlsHost, opts.CertFileName, opts.CertPassword) : null);
            client.Connect();
            if (auth != null)
            {
