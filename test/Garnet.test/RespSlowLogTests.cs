...
namespace Garnet.test
{
    ...
    public class RespSlowLogTests
    {
        ...
        public void Setup()
        {
            ...
            server = TestUtils.CreateGarnetServer(TestUtils.MethodTestDir, disablePubSub: true, latencyMonitor: false, disableObjects: false, slowLogThreshold: slowLogThreshold, enableBlockingOperations: true);
            server.Start();
        }
