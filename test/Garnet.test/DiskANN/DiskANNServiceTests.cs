...
namespace Garnet.test
{
    ...
    public class DiskANNServiceTests : AllureTestBase
    {
        ...
        private delegate byte InlineFilterCallbackDelegate(ulong context, uint id);
        ...
        public void CheckInternalId()
        {
            ...
            unsafe byte InlineFilterCallback(ulong context, uint id)
            {
                return 1;
            }
        ...
        public void VADD()
        {
            ...
            var res1 = db.Execute("VADD", ["foo", "VALUES", "4", "1.0", "1.0", "1.0", "1.0", new byte[] { 1, 0, 0, 0 }, "NOQUANT", "EF", "128", "M", "32"]);
