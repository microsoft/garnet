...
namespace Garnet
{
    ...
    sealed class TestProcedureHash : CustomTransactionProcedure
    {
        ...
        private static bool TestAPI<TGarnetApi>(TGarnetApi api, ref SessionParseState parseState) where TGarnetApi : IGarnetApi
        {
            ...
            var myHash = GetNextArg(ref parseState, ref offset);
            ...
            {
                pairs[i].field = GetNextArg(ref parseState, ref offset);
                pairs[i].value = GetNextArg(ref parseState, ref offset);
            ...
            // HDEL
            var elementRemove = GetNextArg(ref parseState, ref offset);
