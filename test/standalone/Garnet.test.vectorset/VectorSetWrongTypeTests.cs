    ...
    public class VectorSetWrongTypeTests : TestBase
    {
        ...
        internal static IEnumerable<RespCommand> GetNonVectorSetCommands()
        {
            ...
            HashSet<RespCommand> knownSafeOnVectorSets = [
                ...
                RespCommand.OBJECT_FREQ,
                RespCommand.OBJECT_HELP,
                RespCommand.OBJECT_IDLETIME,
                RespCommand.OBJECT_REFCOUNT,
                RespCommand.PERSIST,
                RespCommand.PEXPIRE,
        ...
        public Task HSCANAsync()
        {
            ...
            static async Task RunCommandAsync(IDatabase db, RedisKey againstKey)
            {
